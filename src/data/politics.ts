...
<ul>
  ...
  <li>
    для организации обратной связи и обработки обращений, полученных через форму на Веб-сайте;
  </li>
...
<ul>
  ...
  <li>технические и поведенческие данные (файлы cookie)</li>
</ul>
<p>
...
<p>
  <strong>5.4.</strong> Обработка персональных данных для каждой цели обработки, указанной в п. 2.3
...
<p>
  <strong>5.5.</strong> Не допускается раскрытие третьим лицам и распространение персональных данных
...
<p>
  <strong>5.6.</strong> Передача персональных данных органам дознания и следствия, в Федеральную
...
<p>
  <strong>5.7.</strong> Оператор принимает необходимые правовые, организационные и технические меры
...
<p>
  <strong>5.8.</strong> Оператор осуществляет хранение персональных данных в форме, позволяющей
...
<p>
  <strong>5.9.</strong> Оператор прекращает обработку персональных данных в следующих случаях:
</p>
...
<p>
  <strong>5.10.</strong> При достижении целей обработки персональных данных, а также в случае отзыва
...
<p>
  <strong>5.11.</strong> При обращении субъекта персональных данных к Оператору с требованием о
...
<p>
  <strong>5.12.</strong> При сборе персональных данных Оператор обеспечивает запись, систематизацию,
...
<p>
  <strong>6.1.</strong> При использовании сайта Оператора неопределенный круг лиц (субъект персональных
...
<p>
  Нажатием кнопки <strong>«ОК»</strong> субъект персональных данных выражает свое согласие на использование файлов cookie.
</p>
<p>
  Нажатием кнопки <strong>«Заказать вызов»</strong> субъект персональных данных выражает свое согласие на обработку его персональных данных путем отправки формы обратной связи.
</p>
<p>
  <strong>6.2.</strong> Оператор на своем официальном сайте собирает и обрабатывает персональные
  данные (имя, номер телефона), использует форму обратной связи.
</p>
<p>
  <strong>6.3.</strong> Оператор на своем официальном сайте собирает и обрабатывает технические 
  (тип устройства, разрешение экрана, операционная система, браузер) 
  и поведенческие данные (файлы cookies, история кликов, время на сайте, глубина скроллинга, записи сессий)
</p>
<p>
  <strong>6.4.</strong> Оператор принимает необходимые и достаточные организационные и технические меры
...
<p>
  <strong>7.1.</strong> Подтверждение факта обработки персональных данных Оператором, правовые основания
...
<p>
  <strong>7.5.3.</strong> Уничтожение персональных данных осуществляет ИП Никуличева Марина Викторовна.
</p>
<p>
  <strong>7.5.4.</strong> Способы уничтожения персональных данных устанавливаются в локальных нормативных
  актах Оператора.
</p>`