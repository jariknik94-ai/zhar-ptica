...
<p>
  <strong>4.2.1.</strong> Клиенты и контрагенты Оператора (физические лица)
</p>
...
<p>
  <strong>4.2.2.</strong> Представители (работники) клиентов и контрагентов Оператора
  (юридических лиц)
</p>
...
<p>
  <strong>6.2.</strong> Оператор на своем официальном сайте не собирает и не обрабатывает персональные
  данные (фамилия, имя, отчество, номер телефона, адрес электронной почты), не использует форму обратной связи.
</p>
<p>
  <strong>6.3.</strong> Оператор на своем официальном сайте собирает и обрабатывает технические 
  (IP-адрес, тип устройства, разрешение экрана, операционная система, браузер) 
